...
//    public ArrayList<Friend> findIdMyFriend(@Param("user") long id_user, @Param("friend") long id_friend);
    ...
    @Query(nativeQuery = true, value = "select friend.status from friend where id_friend_id = :friend and id_user_id = :user;")
    public int getStatus(@Param("friend")long id_friend, @Param("user") long id_user);
